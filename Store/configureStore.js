...
import toggleEvent from './Reducers/toggleEventReducer'
import filterEvent from './Reducers/filterReducer'
...
export default createStore(persistCombineReducers(rootPersistConfig, {setEventId, toggleEvent, filterEvent}))
//export default createStore(setEventId)
toggleEvent
